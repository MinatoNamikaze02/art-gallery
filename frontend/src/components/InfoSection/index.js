...
import { InfoContainer, InfoWrapper, InfoRow, Column1, Column2, TopLine, Heading, SubHeading, TextWrapper, BtnWrap, ImgWrap, Img} from './style/infosection'
import { Button } from '../GlobalButton/buttonElement'


export default function InfoSection({aboutSection, img}){
    return (
        <>
